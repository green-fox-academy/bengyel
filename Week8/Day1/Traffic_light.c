...
int main(void)
{
    ...
    LEDS.Pin = GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_8;	/* setting up 2 pins at once with | operator */
    ...
    TimHandle.Init.Prescaler		= (10800 - 1) * 6;	/* 108000000/10800=10000 -> speed of 1 count-up: 1/10000 sec = 0.1 ms */
    TimHandle.Init.Period		= 20000 - 1;	/* 10000 x 0.1 ms = 1 second period */
