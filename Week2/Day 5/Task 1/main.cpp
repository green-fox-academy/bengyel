...
void draw()
{
    ...
    int right = 25;
    for (int i = 0; i < 14; i++) {
        SDL_SetRenderDrawColor(gRenderer, 210 , 0x00 , 0xFF , 0xFF );
        SDL_RenderDrawLine(gRenderer, left, 0, 360, right);
        left +=25;
        right += 25;
    }
    for (int j = 0; j < 14; j++) {
        SDL_SetRenderDrawColor(gRenderer, 0x00 , 0xFF , 0x00 , 0xFF );
        SDL_RenderDrawLine(gRenderer, 0, greenleft, greenright, 360);
        greenright -= 25;
        greenleft -=25;
